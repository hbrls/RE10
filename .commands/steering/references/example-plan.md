...
## Phase 1: Requirements (requirements.md，合并 Proposal + Requirements)
...
## Phase 2: Plan (plan.md，合并 Design + Tasks)
...
1. **Clear progression** from requirements → plan（design + tasks）
